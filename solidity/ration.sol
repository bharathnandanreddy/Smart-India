...
contract rice {
   struct item{
    ...
    constructor()public payable{
        ...
        users[msg.sender].item1.name="RICE";
        users[msg.sender].item1.stock=999999;
        users[msg.sender].item2.name="WHEAT";
        users[msg.sender].item2.stock=999999;
        users[msg.sender].item3.name="SUGAR";
    ...
    function sendItem(string memory _id,address sender,address receiver,uint amount,uint i) public payable{
        
            transactions[_id].receiver=receiver;
            transactions[_id].sender=sender;
    ...
    function setUser(string memory n,address  ad,uint stock)payable public{
        users[ad].name=n;
        users[ad].adds=ad;
        users[ad].item1.name="RICE";
        users[ad].item1.stock=stock;
        users[ad].item2.name="WHEAT";
        users[ad].item2.stock=stock;
        users[ad].item3.name="SUGAR";
